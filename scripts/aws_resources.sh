...
vpc="vpc-0e62d42a1c0ca934e"
region="eu-central-1"

# Ensure consistent quoting and spacing for filters
...
aws ec2 describe-nat-gateways --region "$region" --filters "Name=vpc-id,Values=$vpc" | grep NatGatewayId
